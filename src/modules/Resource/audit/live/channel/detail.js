...
//  审核类型：1=广告 2=布局 3=媒资
const auditType = OperateAuditType.LiveChannel
...
class ChannelDetail extends Component {
  ...
  componentWillMount() {
    ...
    this.props.dispatch(
      getChannelAuditLog({ serviceId: serviceId, type: auditType })
    )
  }
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFieldsAndScroll((err, values) => {
      ...
      this.props.dispatch(postChannelAudit(fieldsValue))
    })
  }
  ...
  render() {
    ...
    return (
      <Card title={this.getCardTitle()}>
        ...
        {/* <FormItem {...formItemLayout} label='资源数量'>
          {detail.sourceCount}
        </FormItem> */}
        {detail.auditStatus === AuditStatusKeyMap.WAIT.value &&
...
const mapStateToProps = state => {
  return {
    detail: state.resource.audit.livechannelDetail,
    auditLogs: state.resource.audit.livechannelAuditLogs,
